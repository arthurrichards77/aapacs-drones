...
def reftfCallback(data):
  ...
  ref_transform.translation.x = data.translation.x
  ref_transform.translation.y = data.translation.y
  ref_transform.translation.z = data.translation.z
...
sub_ref_pos = rospy.Subscriber('ref_tf', Transform, reftfCallback)
