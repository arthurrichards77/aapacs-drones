...
aapacs_folder = rospy.get_param('aapacs_folder')
print "Package folder will be %s" % aapacs_folder
...
preamble="""<?xml version="1.0"?>
  ...
  <xacro:include filename="$(find aapacs_drones)/urdf/drone_base.urdf.xacro" />
...
for drone in drone_names:
  f.write("""  <include file="$(find aapacs_drones)/launch/single_virtual.launch">
